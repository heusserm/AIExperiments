...
for turn in range(MAX_TURNS):
    ...
    response_a = get_response(chat_a, temperature=0.5, frequency_penalty=0.8, presence_penalty=0.3)
    ...
    response_b = get_response(chat_b, temperature=0.5, frequency_penalty=0.8, presence_penalty=0.3)
